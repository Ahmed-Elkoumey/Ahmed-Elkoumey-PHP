...
class Product extends DataBsaeConnect implements ContractCrud {
    private $id,$name_en,$name_ar,$code,$price,$quantity,$desc_en,$desc_ar,
    $image,$status,$brand_id,$sub_ctaeories_id,$created_at,$updated_at;
    /**
     * Get the value of id
     */ 
    ...
    /**
     * Get the value of sub_ctaeories_id
     */ 
    public function getSub_ctaeories_id()
    {
        return $this->sub_ctaeories_id;
    }

    /**
     * Set the value of sub_ctaeories_id
     *
     * @return  self
     */ 
    public function setSub_ctaeories_id($sub_ctaeories_id)
    {
        $this->sub_ctaeories_id = $sub_ctaeories_id;
